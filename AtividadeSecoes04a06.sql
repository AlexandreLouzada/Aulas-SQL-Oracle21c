--------------------------------------------------------------------------------
-- Ajuste estrutural necessário (para Q10 e Q12)
-- A tabela CONTA do seu schema não tinha data_abertura. Vamos criar e popular.
--------------------------------------------------------------------------------
ALTER TABLE conta ADD (data_abertura DATE);

-- Popular com datas nos últimos 3 anos (distribuição aleatória)
UPDATE conta
...
-- (MOD aceita números com decimais; o resultado também pode ter decimais)
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
SELECT SYSDATE + 30 AS data_vencimento
FROM dual;
...
--------------------------------------------------------------------------------
SELECT conta_numero, TRUNC(SYSDATE - data_abertura) AS dias_de_uso
FROM conta;


--------------------------------------------------------------------------------
-- Questão 11: Saldo formatado como moeda (BRL, vírgula decimal)
-- Usando máscara com NLS explícito para garantir R$ e vírgula
--------------------------------------------------------------------------------
SELECT
  'R$ ' || TO_CHAR(saldo, 'FM999G999G990D00',
                   'NLS_NUMERIC_CHARACTERS=,.' ) AS saldo_formatado
FROM conta;

-- Alternativa com símbolo local:
-- SELECT TO_CHAR(saldo, 'FML9G999G990D00',
--                'NLS_CURRENCY=R$ NLS_NUMERIC_CHARACTERS=,.') AS saldo_formatado
-- FROM conta;
...
--------------------------------------------------------------------------------
-- Questão 13: Substituir saldo nulo por zero
-- Observação: no seu schema original SALDO é NOT NULL; aqui é apenas didático.
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Questão 14: Substituir cidade nula por 'Sem cidade'
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Questão 15: Classificar clientes por região com base na cidade
--------------------------------------------------------------------------------
SELECT cliente_nome,
       CASE cidade
...
--------------------------------------------------------------------------------
-- Questão 16: Nome do cliente, número da conta e saldo
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Questão 17: Nome do cliente e nome da agência
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- Questão 18: Todas as agências e seus clientes (inclui agências sem clientes)
--------------------------------------------------------------------------------
